...
trait tXMLParserAdapter {
  ...
  def _getall_xml_elements(elementTag: String)(XMLString: String): Array[String]
  ...
  def _get_xml_element(elementTag: String)(XMLString: String): String
  ...
  def _get_xml_attribute(elementTag: String, attribute: String)(XMLString: String): String
